from Sprint_1.POM.Admin.testdata_new_product import TESTDATA2
...
class TestTC(object):
    ...
    def test_delete_product_no(self):
        ...
        self.pageMain.button_delete(TESTDATA2['Product ID']).click()
        ...
        for i in self.pageMain.product_list():
            product_id_list.append(i.get_attribute("id"))
        assert (TESTDATA2['Product ID']) in product_id_list
    ...
    def test_delete_product_yes(self):
        ...
        for i in self.pageMain.product_list():
            product_id_list.append(i.get_attribute("id"))
        assert TESTDATA2['Product ID'] not in product_id_list
